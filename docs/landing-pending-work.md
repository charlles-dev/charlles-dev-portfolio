...
| SEO e descoberta | Concluídos schemas de projetos na home, breadcrumbs/schema nas páginas editoriais, rota localizada “Agora”, rota localizada “Processo”, fallback 404 noindex fora do sitemap, sitemap e crawler HTML atualizado. |
...
| Fallback de navegação | Concluído: 404 global e fallback localizado na direção “avatar procurando a rota”, com placa de caminhos, CTAs, cópia PT-BR/EN/ES, noindex e validação HTTP/visual em produção. |
