...
import CharllesPhoto from "@assets/images/game/hud-me1.png";
import CharllesPhotoWebP from "@assets/images/game/hud-me1.webp";
        ...
        >
            <div className="narrative-overlay__wrapper">
                <div className="narrative-overlay__character-container">
                    <picture>
                        <source srcSet={CharllesPhotoWebP} type="image/webp" />
                        <img
                            src={CharllesPhoto}
                ...
                <div className="narrative-overlay__dialogue-box">
                    <h3 className='narrative-overlay__name'>{identity.name}</h3>
