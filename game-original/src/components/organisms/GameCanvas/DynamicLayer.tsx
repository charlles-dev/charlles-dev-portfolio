    ...
    return (
        <div className="game-canvas__dynamic-layer">
            {WORLD_ENTITIES.map((obj) => (
                <WorldEntity key={obj.id} object={obj} />
            ))}
            {hoverPos && (
                <div
            ...
            {nearbyObject && (
                ...
                >
                    <kbd>E</kbd>
                    <span>
                        {nearbyObject.id === 'computer' && t('level_select_desktop')}
                        {nearbyObject.id === 'resume' && t('level_select_curriculum')}
                        {nearbyObject.id === 'videoGame' && t('level_select_videogame')}
                    </span>
                </div>
            )}
