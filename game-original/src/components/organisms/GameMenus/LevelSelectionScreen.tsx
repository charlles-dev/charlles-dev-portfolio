...
import charllesImage from '@/assets/images/game/idleAnim-Sheet.png';
    ...
    return (
        ...
        >
            ...
            <div className="level-selection__grid">
                ...
                >
                    <div className="level-selection__image level-selection__image--player">
                        <span className="level-selection__player-sprite" style={{ backgroundImage: `url(${charllesImage})` }} />
                    </div>
                ...
                >
                    <div className="level-selection__image level-selection__image--room level-selection__image--resume" />
                ...
                >
                    <div className="level-selection__image level-selection__image--room level-selection__image--computer" />
                ...
                >
                    <div className="level-selection__image level-selection__image--room level-selection__image--videogame" />
