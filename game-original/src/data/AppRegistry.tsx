...
import iconProgram from '@assets/icons/icon-program.png';
...
const ArcadeCollection = lazy(() => import('@/features/Arcade/ArcadeCollection').then(m => ({ default: m.ArcadeCollection })));
const ServerConsole = lazy(() => import('@/features/ServerConsole/ServerConsole').then(m => ({ default: m.ServerConsole })));
...
export const AppRegistry: AppDefinition[] = [
  ...
  {
    id: APP_IDS.ARCADE,
    title: 'Charlles Arcade',
    icon: iconProgram,
    component: () => <ArcadeCollection embedded />,
    defaultSize: { width: 900, height: 650 },
    visibility: { desktop: true, programs: true },
  },
  {
    id: APP_IDS.SERVER_CONSOLE,
