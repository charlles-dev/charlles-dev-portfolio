...
export const Paint = () => {
  ...
  const [color, setColor] = useState('#0a0b09');
  const [secondaryColor, setSecondaryColor] = useState('#e6e6d8');
  ...
  const colors = [
    '#0a0b09', '#141612', '#1f231a', '#323a25',
    '#52661d', '#9ebf2e', '#d7f45b', '#efff9a',
    '#547e48', '#7fa95b', '#b6d389', '#66685f',
    '#abae9f', '#e6e6d8', '#612d1d', '#8f432b',
    '#ca6641', '#eba67e', '#704a2f', '#a16f44',
    '#d3ae77', '#f6f4e1',
  ];
