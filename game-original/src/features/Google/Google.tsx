          ...
          <section>
            <div className="google-page-container">
              ...
              <div id="contact" className="google-section-box google-page-text">
                ...
                <p>
                  {t('label_email')}: <a href={`mailto:${identity.email}`} className="google-nav-link">{identity.email}</a>
                </p>
                <p>
                  LinkedIn: <a href={identity.linkedin} className="google-nav-link" target="_blank" rel="noopener noreferrer">{identity.linkedinLabel}</a>
                </p>
                <p>
                  GitHub: <a href={identity.github} className="google-nav-link" target="_blank" rel="noopener noreferrer">{identity.githubLabel}</a>
                </p>
