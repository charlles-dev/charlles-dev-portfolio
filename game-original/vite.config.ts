...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Entre Camadas | Um jogo Charlles.dev',
        short_name: 'Entre Camadas',
        description: 'Interactive full-stack software engineering portfolio with a top-down game, a Windows 95 desktop and playable technical experiments.',
        theme_color: '#d7f45b',
        background_color: '#0a0b09',
        display: 'standalone',
        start_url: '/game/original/',
        scope: '/game/original/',
        icons: [
          {
