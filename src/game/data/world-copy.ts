...
export function getWorldCopy(locale: GameLocale): WorldCopy {
  if (locale === "en") {
    return {
      pausePaused: "The signal waits. Press ESC to resume.", pauseResumed: "The exploration continues.", threatDamage: "The scan cone found the Lumen signature.", checkpointRestore: "The signature was lost. The Anchor returned you to the last safe state.", progressRestored: "Progress restored. The station was waiting for your return.", restoredCheckpoint: "Checkpoint restored",
  ...
  if (locale === "es") {
    return {
      pausePaused: "La señal espera. Pulsa ESC para continuar.", pauseResumed: "La exploración continúa.", threatDamage: "El cono de escaneo encontró la firma Lumen.", checkpointRestore: "La firma se perdió. el Ancla te devolvió al último estado seguro.", progressRestored: "Progreso restaurado. La estación esperaba tu regreso.", restoredCheckpoint: "Checkpoint restaurado",
  ...
  return {
    pausePaused: "O sinal aguarda. Pressione ESC para retomar.", pauseResumed: "A exploração continua.", threatDamage: "O cone de varredura encontrou a assinatura Lumen.", checkpointRestore: "A assinatura foi perdida. A Âncora devolveu você ao último estado seguro.", progressRestored: "Progresso restaurado. A estação aguardava o seu retorno.", restoredCheckpoint: "Checkpoint restaurado",
